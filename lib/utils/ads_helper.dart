...
//  static String appId = 'ca-app-pub-3940256099942544~1458002511'; //test
  ...
  //FB Banner
  static String fbBannerId_1 = '2632898007026944_2632898080360270';
  static String fbBannerId_2 = '2632898007026944_2632898083693603';

  //FB Inter
  static String fbInterId_1 = '2632898007026944_2632898077026937';
  static String fbInterId_2 = '2632898007026944_2632898087026936';

  //FB Native Banner
  static String fbNativeBannerId = '';

  //FB Native
  static String fbNativeId = '2977255225699775_2977255439033087';
  ...
  showFbInter() {
    if (_isInterstitialAdLoaded == true) {
      ...
      if (b) {
        ...
        print('===========(Fb Inter : No Chance)===========> Better chance next time ;)');
      }
    } else
      print(
...
/*  showAdmobInter() async {
  ...
  showInter() async {
//    var n = new Random().nextInt(AdsHelper.adsFrequency);
//    if (n % 2 == 0) {
//      showAdmobInter();
//    } else {
      showFbInter();
